...
### [1] [Probing quantum spin liquids with multiple quantum coherences](https://arxiv.org/abs/2609.25193)
...
### [3] [Localized Decoherence as a Constructive Tool: An Optical Simulation of Matter-Wave Interference](https://arxiv.org/abs/2609.25227)
...
### [4] [End-to-End Quantum Semantic Communication with Variational Quantum Neural Networks](https://arxiv.org/abs/2609.25044)
...
### [5] [Efficient Ion-Photon Quantum Interface with Long-Working-Distance Exceeding 26 mm](https://arxiv.org/abs/2609.25598)
...
### [7] [Post-selected enhancement of phase sensitivity in a two-path interferometer](https://arxiv.org/abs/2609.25673)
...
### [8] [Pulsed coherent and squeezed driving of a spin-$S$ emitter as a deterministic source of Wigner-negative light](https://arxiv.org/abs/2609.25135)
...
### [9] [Photon-Statistics Control of Strong-Field Rydberg-State Excitation](https://arxiv.org/abs/2609.25753)
...
### [10] [Universal Fidelity Law for Linear-Optical Entangling Gates](https://arxiv.org/abs/2609.25861)
...
### [11] [Measurement-Induced Phase Transitions and Logical-Space Localization in Floquet Monitored Clifford Circuits](https://arxiv.org/abs/2609.25201)
...
### [12] [Adaptive thresholding for scalable measurement-based qubit reset](https://arxiv.org/abs/2609.25208)
...
### [13] [Thermodynamic Proof of Quantumness without Structure](https://arxiv.org/abs/2609.25211)
...
### [14] [Fluctuation-Driven Nonlinear Amplification of Quantum Statistics](https://arxiv.org/abs/2609.26674)
...
### [15] [Nonlocal advantage of quantum coherence in tau-lepton pairs from electron--positron collisions](https://arxiv.org/abs/2609.25214)
...
### [29] [When Quantum Meets AI: Quantum Methods for Machine Learning and Machine Learning Methods for Quantum Systems](https://arxiv.org/abs/2609.25641)
*Tak Hur*
...
### [30] [Schrödingerization for quantum linear systems problems](https://arxiv.org/abs/2609.25660)
...
### [31] [$\mathsf{BQP} \subseteq \mathsf{IP}$ Does Not Relativize](https://arxiv.org/abs/2609.25680)
...
### [32] [Post-Selection-Based Stochastic Quantum Battery](https://arxiv.org/abs/2609.25699)
...
### [33] [Enhanced Atomic Magnetometry with a Pinched Spin State](https://arxiv.org/abs/2609.25714)
...
### [34] [The Failure of Simultaneous Quantum Typicality](https://arxiv.org/abs/2609.25726)
*Benoit Collins*
...
### [35] [An asymmetric atom-photon architecture for device-independent quantum key distribution over 25\,km](https://arxiv.org/abs/2609.25795)
...
### [36] [Exponential Quantum Advantage in Testing Fourier Dimensionality](https://arxiv.org/abs/2609.25816)
*Kenny Chen*
...
### [37] [Quantum survival in hybrid pursuit dynamics - a lion chasing a lamb problem](https://arxiv.org/abs/2609.25844)
...
### [63] [Strong matchgate designs in nearly optimal depth](https://arxiv.org/abs/2609.26677)
...
### [64] [Transversal non-Clifford gates on good quantum locally testable codes](https://arxiv.org/abs/2609.26691)
...
### [65] [When are bosonic Gaussian states classical to learn?](https://arxiv.org/abs/2609.26705)
...
### [66] [A quantum lower bound for path finding in welded trees](https://arxiv.org/abs/2609.26712)
...
### [67] [Evidence for a low-gap component in compressively stressed niobium thin films](https://arxiv.org/abs/2609.26714)
...
### [68] [Good Quantum Locally Testable Codes from Product Expansion](https://arxiv.org/abs/2609.26735)
...
### [69] [A Syndrome-Extraction Framework for Distributed Lattice Surgery on Arbitrary Rotated Surface-Code Layouts](https://arxiv.org/abs/2609.26736)
...
### [70] [Explicit channels with unbounded gains in classical communication using entangled inputs](https://arxiv.org/abs/2609.26743)
...
### [71] [Quantum Broadcast Channels with Mutually Confidential Messages](https://arxiv.org/abs/2609.26750)
...
### [72] [On the Complexity of Finding Decoherence Free Subspaces](https://arxiv.org/abs/2609.26769)
*Evan Borras*
...
### [73] [Error Suppression in Distributed Quantum Computing with Heterogeneous-Distance Lattice Surgery](https://arxiv.org/abs/2609.26784)
...
### [74] [Quantum Advantage for Distributed Symmetry Breaking](https://arxiv.org/abs/2609.26788)
...
### [75] [Search for boosted vector boson scattering $W^{\pm}W^{\pm}H$ production in final states with same-sign leptons and $b$-jets in proton-proton collisions at $\sqrt{s}=$13 TeV with the ATLAS detector](https://arxiv.org/abs/2609.25153)
*ATLAS Collaboration*
...
### [76] [Observation of $η(2600)$ and Threshold Enhancements in the $Λ\barΛ$ System](https://arxiv.org/abs/2609.25158)
...
### [77] [Discovery of an unexpectedly light and narrow beauty-strange state](https://arxiv.org/abs/2609.25178)
...
### [78] [Fast Timing at Colliders: From Scintillator Hodoscopes to MicroPattern Arrays](https://arxiv.org/abs/2609.25358)
*Sebastian N. White*
...
### [79] [Measurement of the $Ω_b^-$ baryon lifetime](https://arxiv.org/abs/2609.25370)
...
### [80] [Spin-spin correlations in $Λ\barΛ$ pair production at the SPD experiment at NICA](https://arxiv.org/abs/2609.25383)
*D. Gubachev,A. Guskov*
...
### [81] [Search for the $^{16}\text{O}(ppp) \rightarrow ^{13}\text{C} π^+ π^+ e^+$ Decay Mode in Super-Kamiokande Using Machine Learning Techniques](https://arxiv.org/abs/2609.25681)
...
### [82] [Feasibility Study of $e^+e^-\to η_cJ/ψ$ Production and Fully-Charmed Tetraquark Searches at STCF](https://arxiv.org/abs/2609.25870)
...
### [83] [Future Muon Physics Experiments: Muon Beams and Experimental Apparatus](https://arxiv.org/abs/2609.25943)
...
### [84] [Improving the CMS High Level Trigger tracking at the HL-LHC with novel and evolved heterogeneous algorithms](https://arxiv.org/abs/2609.26376)
*Mario Masciovecchio*
...
### [85] [An enhanced track reconstruction for the CMS experiment at the HL-LHC](https://arxiv.org/abs/2609.26383)
*Mario Masciovecchio*
...
### [86] [Complementary Time- and Distance-Based Methods for Cosmogenic $^{9}$Li/$^{8}$He Background Estimation](https://arxiv.org/abs/2609.26538)
...
### [87] [Extending the reconstruction of displaced tracks at CMS during the HL-LHC with Line Segment Tracking](https://arxiv.org/abs/2609.26695)
*Jade Chismar*
