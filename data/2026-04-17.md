...
### [1] [Search for heavy resonances decaying into four-lepton final states via light bosons in proton-proton collisions at $\sqrt{s}$ = 13 TeV](https://arxiv.org/abs/2604.14236)
*CMS Collaboration*
...
Motivation: 寻找超出标准模型的新物理现象，特别是通过双中间玻色子衰变为四轻子的共振态，探索LHC尚未研究过的相空间区域（双轻子质量0.4-15 GeV）。

Method: 使用CMS实验收集的138 fb⁻¹积分亮度13 TeV质子-质子对撞数据，采用新技术增强对来自轻中间玻色子衰变的共线双轻子对（重建为单个合并对象）的灵敏度。

Result: 未观察到数据相对于背景预测的显著超出，为四轻子共振态的产生截面设置了上限，包括双轻子质量在0.4-15 GeV范围内先前LHC未探索的相空间。

Conclusion: 在搜索的质量范围内未发现新物理信号，但为未来类似搜索提供了重要的截面限制，特别是在低双轻子质量区域。
...
### [2] [Expected Sensitivity of the Light Dark Matter eXperiment to Long-Lived Dark Photons and Axion-Like Particles](https://arxiv.org/abs/2604.14359)
...
TL;DR: LDMX实验通过电子束固定靶设计，主要探测亚GeV暗物质粒子，同时具备探测可见衰变长寿命粒子的能力，提供对暗物质领域的广泛探索。


<details>
  <summary>Details</summary>
Motivation: 当前对亚GeV暗物质粒子的探测能力有限，需要模型无关的高灵敏度实验。LDMX旨在填补这一空白，同时扩展对暗物质领域的探索范围。

Method: 使用基于Geant4工具包的详细模拟，结合真实的探测效率和本底水平，评估LDMX识别可见衰变长寿命粒子的能力。

Result: LDMX能够达到与当前运行的其他实验相竞争的灵敏度，且其探测的模型与LDMX旗舰缺失动量分析所探测的模型具有互补性。

Conclusion: 通过同时搜索不可见暗物质和可见衰变长寿命粒子，LDMX将显著推进轻暗物质的搜索，并提供对亚GeV暗物质领域的广泛探索。
...
### [3] [Dalitz decay of $K^*(892) \rightarrow K \ell^+\ell^-$: A New Probe for Hadronic Structure and Dark Photon Searches](https://arxiv.org/abs/2604.14735)
*Benhou Xiang,Wanling Chang,Shuangshi Fang,Jingqing Zhang*

Main category: hep-ex

TL;DR: 首次全面研究稀有Dalitz衰变K*→Kℓ⁺ℓ⁻，预测分支比和双轻子质量谱，探索K*K跃迁形状因子和暗光子搜索


<details>
  <summary>Details</summary>
Motivation: 研究K*(892)→Kℓ⁺ℓ⁻稀有衰变，通过虚拟光子转化为轻子对的过程，探测K*K跃迁形状因子F_{K^*K}(q²)和介子结构，同时探索暗光子A'玻色子在双轻子谱中的窄共振信号

Method: 采用单极点近似描述跃迁形状因子，首次计算该稀有衰变道的分支比，分析双轻子质量谱，并研究在BESIII实验上探测暗光子的实验灵敏度和新物理机会

Result: 首次提供了K*(892)→Kℓ⁺ℓ⁻衰变的分支比预测和双轻子质量谱，建立了该衰变作为强子结构研究和暗区搜索的新实验室，展示了在BESIII实验上探测暗光子的潜力

Conclusion: K*(892)→Kℓ⁺ℓ⁻衰变为研究强子结构和暗区物理提供了新的平台，通过跃迁形状因子和暗光子搜索，该衰变过程在BESIII实验上具有重要的新物理探索价值
...
### [4] [Multiboson and VBS measurements in ATLAS and CMS](https://arxiv.org/abs/2604.14753)
*Santiago Folgueras*

Main category: hep-ex

TL;DR: 本文综述了ATLAS和CMS合作组在LHC上进行的多玻色子和矢量玻色子散射（VBS）测量，包括精确双玻色子截面测量、Wγ产生中的CP敏感和极化观测量、半轻子和全轻子末态中的VBS观测（含首次13.6 TeV测量）以及三玻色子过程观测。


<details>
  <summary>Details</summary>
Motivation: 对标准模型电弱规范扇区进行全面测试，通过多玻色子和矢量玻色子散射过程检验标准模型预测，并为超出标准模型的新物理提供约束。

Method: 采用ATLAS和CMS探测器在LHC上收集的质子-质子对撞数据，进行多玻色子产生和矢量玻色子散射过程的测量。使用有效场论框架分析异常规范耦合，开发新的CP敏感和极化观测量。

Result: 报告了精确的双玻色子截面测量结果，Wγ产生中的新CP敏感和极化观测量，半轻子和全轻子末态中矢量玻色子散射的观测（包括首次在13.6 TeV能量下的测量），以及三玻色子过程的观测结果。

Conclusion: 这些结果构成了对标准模型电弱规范扇区的全面测试，并在有效场论框架下为异常规范耦合提供了严格约束，验证了标准模型在高能标下的行为。
...
### [5] [Study of the $B^0 \to Λ_c^+ \barΛ_c^- K_S^0$ decay](https://arxiv.org/abs/2604.15040)
...
TL;DR: 首次在LHCb上研究B^0→Λ_c^+Λ_c^-K_S^0衰变，测量其相对于B^+→Λ_c^+Λ_c^-K^+的分支比，并在Λ_c^+K_S^0系统中发现两个共振态的证据。


<details>
  <summary>Details</summary>
Motivation: 首次研究B^0→Λ_c^+Λ_c^-K_S^0衰变过程，探索Λ_c^+K_S^0系统中的共振态结构，验证与Λ_c^+K^-系统中观测到的态的同位旋伙伴关系。

Method: 使用LHCb实验在√s=13 TeV质子-质子对撞中记录的5.4 fb⁻¹积分亮度数据，通过相对分支比测量方法，分析Λ_c^+K_S^0系统的共振结构。

Result: 测得相对分支比为0.53±0.05(统计)±0.05(系统)，在Λ_c^+K_S^0系统中发现Ξ_c(2923)^+和Ξ_c(2939)^+两个共振态的证据，显著性为3.9σ，这些态与Λ_c^+K^-系统中观测到的态一致为同位旋伙伴。

Conclusion: 首次观测到B^0→Λ_c^+Λ_c^-K_S^0衰变并测量其分支比，在Λ_c^+K_S^0系统中发现两个Ξ_c^+共振态，支持它们作为Λ_c^+K^-系统中观测到的态的同位旋伙伴。
...
### [6] [Scrambling of Entanglement from Integrability to Chaos: Bootstrapped Time-Integrated Spread Complexity](https://arxiv.org/abs/2604.14224)
*M. Süzen*

Main category: quant-ph

TL;DR: 提出一种时间积分复杂度度量，用于诊断量子遍历性程度，通过集成哈密顿量的数值自举实现，探究不同遍历区域


<details>
  <summary>Details</summary>
Motivation: 需要一种能够诊断量子混沌从早期到晚期的鲁棒方法，量化最大纠缠态在幺正演化集成中的混洗动力学

Method: 提出时间积分复杂度度量，应用哈密顿量集成的数值自举实现，使用Rosenzweig-Porter集成，分析不同幺正演化路径

Result: 积分展宽复杂度提供了跨不同遍历区域的精细分辨率，能够有效诊断量子混沌的演化过程

Conclusion: 该方法为从早期到晚期诊断量子混沌提供了鲁棒工具，时间积分复杂度是量化量子遍历性的有效度量
...
### [7] [Consciousness, Quantum Mechanics, and the Limits of Scientific Objectivism](https://arxiv.org/abs/2604.14234)
*John B. DeBrota,Christian List*

Main category: quant-ph

TL;DR: 该论文探讨意识与量子力学之间的哲学平行性，两者都挑战经典客观主义世界观，并提出三种非客观主义回应方案


<details>
  <summary>Details</summary>
Motivation: 意识与量子力学是科学中最令人困惑的现象，虽然有些学者认为它们相关，但这一观点常被批评为"最小化神秘性"谬误。本文旨在揭示一个较少被讨论的平行性：两者都挑战科学的经典客观主义世界观，并在特定假设下与"非关系主义"、"非碎片化"和"单一世界"等形而上学命题产生张力

Method: 采用哲学分析方法，识别意识与量子力学共同挑战的经典客观主义世界观的三个核心形而上学命题，并系统阐述三种可能的非客观主义回应方案：关系主义、碎片化主义和多重主观世界理论

Result: 识别出意识与量子力学共同挑战的三个形而上学命题：非关系主义（否认性质是关系性的）、非碎片化（否认现实是碎片化的）、单一世界（否认存在多个主观世界）。基于这些挑战，提出了三种非客观主义回应方案，并分析了各自的优缺点

Conclusion: 意识与量子力学确实存在深刻的哲学平行性，都挑战经典客观主义世界观。通过分析三种非客观主义回应方案（关系主义、碎片化主义、多重主观世界理论），为理解这两个领域提供了新的哲学框架，并指出了未来研究的方向
...
### [8] [Magnitude Is All You Need? Rethinking Phase in Quantum Encoding of Complex SAR Data](https://arxiv.org/abs/2604.14229)
*Sakthi Prabhu Gunasekar,Prasanna Kumar R*

Main category: quant-ph

TL;DR: 量子机器学习中SAR目标识别的相位信息价值取决于模型架构：混合量子-经典模型中仅使用幅度编码效果最佳，而纯量子模型中相位信息至关重要。


<details>
  <summary>Details</summary>
Motivation: SAR数据本质上是复数值的，而量子机器学习模型天然在复希尔伯特空间中运行。这种表面上的对齐表明，在SAR自动目标识别中同时包含幅度和相位信息应该能提高性能。本研究旨在系统评估这一假设。

Method: 在MSTAR基准数据集上，采用统一的实验框架比较五种量子编码策略：仅幅度编码、联合复数编码、I/Q基编码、预处理相位编码和纯量子编码。评估了混合量子-经典架构和纯量子架构的性能差异。

Result: 在混合量子-经典架构中，仅幅度编码表现最佳（3类任务99.57%准确率，8类任务71.19%），相位感知方法提供可忽略（~0%）或负面的改进。而在纯量子架构中（仅184-224个可训练参数，无经典组件），相位信息变得至关重要，贡献高达21.65%的准确率提升。

Conclusion: 相位信息的效用并非数据固有属性，而是关键依赖于模型架构。混合模型依赖经典组件补偿缺失的相位信息，而纯量子模型需要相位来构建判别性表示。这些发现为NISQ时代复杂值数据在QML中的编码提供了实用设计指南，并强调了编码-架构协同设计的重要性。
...
### [9] [Warring Contextualities - Provably Classical vs Provably Nonclassical](https://arxiv.org/abs/2604.14319)
...
<details>
  <summary>Details</summary>
Motivation: 文献中存在Kochen-Specker语境性和Spekkens（广义）语境性两种不同定义，但研究者通常只关注其中一种，缺乏对这两种概念的比较分析。需要调和这两种方法，理解它们之间的关系。

Method: 提出理论框架，将Kochen-Specker语境性视为系统根本非经典性的推广，而将Spekkens非语境性视为系统经典性的推广。通过这种视角将两种方法调和为经典性/非经典性层次结构中的不同阶段。

Result: 建立了两种语境性概念的统一理解框架，表明Kochen-Specker语境性对应非经典性，Spekkens非语境性对应经典性，两者可以共存于同一层次结构中。

Conclusion: 两种语境性定义不是相互排斥的，而是经典性/非经典性连续谱中的不同阶段。这种调和有助于更全面地理解量子系统的经典和非经典特性。
...
TL;DR: 该研究首次在中间距离尺度上直接测量了锶原子与介电表面之间的卡西米尔-波尔德力，通过原子能级位移直接观测这一量子真空效应。


<details>
  <summary>Details</summary>
Motivation: 卡西米尔-波尔德效应是量子真空涨落的重要表现，但以往在中间距离尺度（原子-表面距离与原子主要跃迁波长相当）的实验主要依赖衍射或量子反射等间接方法，缺乏直接测量。

Method: 使用魔幻波长光学晶格将超冷锶原子限制在距表面189(2)nm处，通过光谱学方法探测原子能级kHz频率的位移，该距离与原子主要461nm跃迁波长处于同一尺度。

Result: 测量结果与量子电动力学计算吻合良好，与短程近似不同，也排除了长程近似，首次在中间距离尺度上直接揭示了卡西米尔-波尔德力。

Conclusion: 该工作为研究不同表面性质和几何形状下的卡西米尔-波尔德效应开辟了新途径，对探索原子-表面势的张量性质以及发展混合原子光学-磁量子器件具有重要意义。
...
TL;DR: SE-QPE是一种改进的量子相位估计算法，通过CSWAP干涉替代受控时间演化，降低资源开销并在Quantinuum H2量子计算机上成功演示


<details>
  <summary>Details</summary>
Motivation: 传统QPE中的受控时间演化需要大量资源，特别是在处理粒子守恒哈密顿量时。SE-QPE旨在减少受控模拟开销，同时保持与非精确本征态的兼容性

Method: SE-QPE使用CSWAP干涉替代受控时间演化，在目标寄存器和参考寄存器之间进行交换操作。对于具有共享本征基的时间演化分解，该方法保留了传统QPE的相位寄存器输出分布

Result: 在FeMoco活性空间范围内，SE-QPE减少了时间演化资源：CX计数减少约33%，T计数减少25%，CX层深度比渐近为3/N。在Quantinuum H2-2上的四量子比特乙烯模型演示成功获得不同能量

Conclusion: SE-QPE通过消除受控模拟开销和实现并行演化，显著降低了QPE的资源需求。辅助寄存器提供了有用的错误检测功能，结合传统QPE和SE-QPE实现可以成为有用选项
...
### [12] [Unconventional Photon Blockade in a Symmetrically Driven Nonlinear Dimer](https://arxiv.org/abs/2604.14963)
*Hamid Ohadi*

Main category: quant-ph

TL;DR: 在对称克尔二聚体中，通过90度相位差的等幅场驱动实现非常规光子阻塞，最小耦合强度J_min=γ/4，克尔非线性U≪γ，产生强反聚束光且二阶关联函数平滑无振荡。
...
Method: 采用对称克尔二聚体（两个耦合的光学腔），使用90度相位差的等幅场进行驱动。通过优化腔间耦合强度J和克尔非线性U，在弱非线性条件(U≪γ)下实现光子阻塞。分析连续波和脉冲激发两种工作模式。

Result: 实现了最小腔间耦合强度J_min=γ/4，在标准光子分子中可实现的弱克尔非线性条件下(U≪γ)产生强反聚束光。二阶关联函数平滑无振荡，可直接用标准探测器分辨。制造缺陷可通过重新调谐驱动相位完全补偿。

Conclusion: 该方案在对称克尔二聚体中实现了鲁棒的非常规光子阻塞，对制造缺陷具有容错性，无需后制造腔体调谐，适用于连续波和脉冲激发，为集成量子光子学中的单光子源提供了实用方案。
...
### [13] [Scalable quantum error correction tailored for a heavy-hex qubit array](https://arxiv.org/abs/2604.14296)
...
TL;DR: 动态指南针码：一种适用于重六边形晶格量子硬件的子系统码，通过噪声特征化提升解码性能，实验显示逻辑错误率改善达38.3%


<details>
  <summary>Details</summary>
Motivation: 为不完美硬件构建可操作的量子计算机，需要开发适合实际设备的可扩展量子纠错码，并设计能够适应设备特定噪声特性的解码策略。

Method: 提出动态指南针码——一种具有新型综合征提取循环的子系统码；使用超导量子比特阵列实现距离-5的该码实例；采用平均电路本征值采样获取详细的上下文相关错误信息；利用测量设备产生的软信息增强解码器性能，并通过后选择检测泄漏错误。

Result: 动态指南针码在重六边形晶格上高效利用量子比特，具有竞争力的阈值；通过噪声信息化的解码方法，在距离-5实现中逻辑错误率提升达38.3%。

Conclusion: 动态指南针码结合详细的噪声特征化和软信息增强的解码策略，为不完美硬件构建实用量子计算机提供了有前景的途径，显著提升了量子纠错性能。
...
TL;DR: 动态罗盘码是一种在heavy-hex晶格上实现的新型量子纠错码，通过创新的测量调度方案获得阈值，并在X和Z基错误保护之间提供权衡。


<details>
  <summary>Details</summary>
Motivation: 开发既易于实现又能在扩展时快速降低逻辑错误率的量子纠错码，以满足可靠执行通用量子算法的硬件需求。

Method: 通过为heavy-hex子系统码的综合征提取电路选择新颖的测量调度方案，构建动态罗盘码。数值评估其性能，分析不同调度方案在X和Z基错误保护之间的权衡。

Result: 动态罗盘码在heavy-hex晶格上实现时占用资源适中，具有阈值特性，不同测量调度方案可在X和Z基错误保护之间提供权衡，并展示了通过晶格手术实现容错逻辑的可能性。

Conclusion: 动态罗盘码是一种有前景的量子纠错码，在实现可行性和纠错性能之间取得了良好平衡，为未来量子计算硬件提供了实用的纠错解决方案。
...
TL;DR: 利用福克空间晶格中的拓扑零能模实现量子计量，通过单元依赖临界性避免传统临界计量中的瓶颈效应，实现从标准到海森堡极限的连续可调标度。


<details>
  <summary>Details</summary>
Motivation: 传统临界量子计量利用系统在相变边界附近增强的灵敏度，但面临两个瓶颈：传感动力学的临界减速和参数传感窗口的急剧收缩。这些瓶颈源于均匀晶格传感的固有特性。

Method: 提出利用福克空间晶格中玻色子阶梯算符矩阵元产生的固有跳跃不均匀性。采用双模Jaynes-Cummings模型，将传感参数编码到FSL的拓扑零能模中。系统参数变为单元依赖，在拓扑相图中描绘出一条曲线。当该曲线接近或跨越拓扑相边界时，出现单元依赖临界性，无需全局调谐晶格接近临界点。外部控制参数可重塑该曲线。

Result: 外部控制参数可连续调节量子Fisher信息从标准标度到海森堡标度的标度行为，同时保持宽广的传感覆盖范围和降低的能隙代价。对单个腔的局域光子数测量即可饱和量子Fisher信息。

Conclusion: 福克空间晶格为基于临界性的量子计量提供了可扩展且实用的途径，通过单元依赖临界性克服了传统临界计量的瓶颈，实现了性能可调的精密测量。
...
TL;DR: 该论文利用表示论工具研究玻色子采样在非稀薄区域（光子碰撞显著）的输出统计特性，特别是证明了输出概率的反集中性，从而强化了玻色子采样在实验相关参数下的计算困难性保证。


<details>
  <summary>Details</summary>
Motivation: 玻色子采样是展示量子优势的主要候选方案，但其输出统计特性在非稀薄区域（模式数随光子数线性增长）仍不明确，特别是反集中性这一计算困难性论证的关键要素在该区域缺乏理解，而这正是实验最感兴趣的参数区域。

Method: 采用表示论工具，推导了粒子数守恒玻色子可观测量二阶矩的闭式表达式，将其表示为算子空间不可约分量投影的希尔伯特-施密特范数，并利用底层对称结构得到了这些投影范数的紧凑解析表达式。

Result: 获得了玻色子可观测量二阶矩的解析表达式，并针对福克态输出概率证明了非稀薄区域的反集中性，结合最近的复杂性理论结果，强化了玻色子采样在实验相关参数下的计算困难性保证。

Conclusion: 该工作填补了玻色子采样在非稀薄区域输出统计特性的理论空白，通过表示论方法建立了反集中性，为玻色子采样在实验相关参数下的计算困难性提供了更坚实的理论基础。
...
TL;DR: 该论文提出了一种基于量子计算的方法来解决组合优化中的最大最小公平分布问题，通过QAOA构造能够表示任意比特串分布的量子电路，在公平割覆盖问题上优于经典算法。


<details>
  <summary>Details</summary>
Motivation: 组合优化中的最大最小公平分布问题通常需要指数级支持的最优分布，这在最坏情况下难以表示和计算。为了解决这一计算复杂度问题，作者寻求量子计算方法来高效处理这类分布优化问题。

Method: 基于量子近似优化算法(QAOA)的动力学李代数分析，构建有限层数的QAOA ansatz，使其能够捕获任意比特串分布。将该方法应用于公平割覆盖问题（经典分数割覆盖问题的公平解释）。

Result: 理论证明该量子算法在某些图结构上优于经典近似算法，并在测试实例上实证表现超越经典算法。构建的量子电路能够有效解决公平割覆盖问题。

Conclusion: 量子计算方法为解决组合优化中的最大最小公平分布问题提供了有效途径，QAOA框架能够表示复杂分布并在公平割覆盖问题上展现出优于经典算法的性能。
...
### [18] [Revealing the physical structure of the general quantum master equation](https://arxiv.org/abs/2604.14382)
...
<details>
  <summary>Details</summary>
Motivation: 传统Lindblad主方程通常需要弱耦合或能量守恒等额外假设，本文旨在探索无任何假设条件下的主方程结构，为量子动力学提供更基本的物理理解。

Method: 在不施加任何额外条件的情况下分析Lindblad主方程的结构，将一般量子动力学表达为自由演化、广义电荷交换（不必须与哈密顿量对易）和纯退相干的组合，并用此框架研究两能级系统的动力学和稳态。

Result: 发现强耦合、粒子交换和非阿贝尔效应具有相同的物理起源，且广义吉布斯态在所有三种情况下都包含一个先前未被考虑的非对易项。

Conclusion: 该研究为量子主方程提供了基于物理过程的新视角，揭示了不同量子现象的统一框架，对理解开放量子系统动力学具有重要意义。
...
TL;DR: 提出一个统一框架，用于联合区域量子态层析与读出误差估计，通过重叠区域分区、局部密度算子和混淆矩阵，以及分布式交替优化方法解决可扩展性问题。


<details>
  <summary>Details</summary>
Motivation: 现有方法存在局限性：重叠层析方法通常假设已知或单独校准的测量，而读出误差估计方法则缺乏重叠区域状态的一致性约束。需要统一框架同时处理量子态估计和读出误差校准。

Method: 将多量子比特系统划分为重叠区域，每个区域分配局部密度算子和局部混淆矩阵，通过共享子系统上的约化态一致性耦合相邻区域。采用分布式交替优化方法：状态更新步骤使用ADMM，混淆矩阵更新在本地并行执行。

Result: 建立了分析保证：局部可识别性的充分条件、总体失配的局部二次增长、内部状态更新过程的收敛性。在Ring、Ladder、Torus和Hub图几何上的仿真表明，联合估计优于固定读出重建，恢复大部分oracle性能，并揭示了状态估计性能、通信和计算之间的权衡。

Conclusion: 该框架为大规模多量子比特系统中量子态估计与读出误差校准提供了统一解决方案，通过分布式优化实现了可扩展性，并在理论和仿真上验证了其有效性。
...
TL;DR: VQLS算法存在O(L²)电路评估瓶颈，本文提出分布式VQLS框架和FWHT-Pauli分解压缩技术，将10量子比特系统的每迭代电路数从2300万减少到9万，保持99.99%保真度，并在超级计算机上验证了可扩展性。


<details>
  <summary>Details</summary>
Motivation: 变分量子线性求解器(VQLS)面临实际可扩展性瓶颈：线性组合酉分解(LCU)需要O(L²)电路评估，其中L在最坏情况下可能随量子比特数指数增长(4^n)，这限制了算法在实际量子硬件上的应用。

Method: 提出两种互补策略：1) 基于NVIDIA CUDA-Q的分布式VQLS框架，支持异步、可扩展的O(L²)代价函数评估分布；2) 基于快速沃尔什-哈达玛变换的Pauli分解结合1%系数阈值化，将LCU项从O(2^n)减少到O(1)，将每迭代电路复杂度从O(n·4^n)压缩到O(n)。

Result: 对于10量子比特三对角Toeplitz系统，实现了256倍减少（从2300万电路减少到90,112电路/迭代），保持99.99%解保真度。在NERSC Perlmutter超级计算机上验证，使用多节点多GPU理想状态向量模拟，在24GPU上实现接近理想的强扩展，96GPU上弱扩展效率达95.3%，系统性能分析获得2.52倍加速。

Conclusion: 分布式VQLS框架结合FWHT-Pauli分解压缩技术有效解决了VQLS的可扩展性瓶颈，为早期容错量子处理器的实际应用提供了可行性指导，并通过系统性能分析确定了分布式量子电路工作负载的最佳资源分配策略。
...
Method: 引入一个全面的物理模型，该模型能够准确预测原始数据的功率谱和概率分布，基于此计算熵源带宽和量子最小熵。模型通过仿真和实验在不同设置下进行了充分验证。

Result: 模型在仿真和实验中均得到显著一致的验证，能够实现实验设置的先验配置，以获得设计的原始数据功率谱和概率分布，从而最大化生成速率或最小熵。

Conclusion: 该物理模型为基于激光相位噪声的量子随机数生成方案提供了完整的理论框架，实现了系统性能的定量评估和优化，填补了现有理论模型的不足。
...
TL;DR: 该论文提出了一种通过线性光学干涉装置后选择对称qudit Dicke态的方法，包括使用和不使用辅助光子的方案，并证明使用辅助光子可以突破无辅助光子方案的成功概率上限。


<details>
  <summary>Details</summary>
Motivation: 多体纠缠是分布式量子应用的关键资源，通过线性光学干涉制备多体纠缠是可行方法。虽然成功干涉的预示通常成本高昂，但后选择纠缠态提供了更易实现的替代方案。
...
Conclusion: 提出的干涉方案家族为量子通信和变分量子计算中的Dicke态后选择提供了灵活且高效的实现途径，特别是使用辅助光子的方案在成功概率方面具有优势。
...
TL;DR: 该研究揭示了驱动自旋系综与超导谐振腔耦合系统中的非平衡多体动力学，发现了从连续波到周期性脉冲超辐射发射的动力学相变，并建立了周期性脉冲超辐射与连续时间晶体之间的基本联系。


<details>
  <summary>Details</summary>
Motivation: 传统腔量子电动力学研究主要集中在连续辐射的超辐射现象，而如何在时域中工程化超辐射以实现周期性脉冲源或频率梳仍未被充分探索。研究旨在探索驱动开放系统中周期性脉冲超辐射的动力学相变及其潜在应用。

Method: 采用驱动耗散腔QED模型，研究驱动自旋系综与片上超导谐振腔耦合的非平衡多体动力学。通过稀土离子自旋系统（同时具有光学和微波跃迁）实现相位同步的双轨超辐射频率梳。

Result: 发现了从连续波到周期性脉冲超辐射发射的动力学相变；揭示了周期性脉冲超辐射相源于集体、周期性重复的自旋动力学，由相干增长、无序和耗散的相互作用稳定；实现了微波和光学域中的相位同步双轨超辐射频率梳。
...
### [24] [Optimal Quantum Logarithmic Trace Inequality](https://arxiv.org/abs/2604.14617)
*Gilad Gour*

Main category: quant-ph

TL;DR: 该论文建立了一个尖锐的对数迹不等式，改进了Cheng等人的界限，将预因子c_s/s替换为更小的常数G_s，该常数通过Lambert W函数有闭式表达，并证明了G_s是最优普适常数。


<details>
  <summary>Details</summary>
Motivation: Cheng等人最近的工作提出了对数迹不等式，但其预因子c_s/s并非最优。本文旨在建立更尖锐的不等式，获得更小的常数，从而改进量子信息理论中的关键原语。

Method: 引入迭代分部积分程序，将最优标量界提升到算子水平而不损失最优性。通过Lambert W函数定义常数G_s，并证明其最优性。

Result: 建立了以G_s为预因子的尖锐对数迹不等式，证明了G_s是最优普适常数。对于密度矩阵，当s≤1/(2log2)时最优性保持，超过该阈值时对易情况有更小常数，非对易情况开放。当s→0时，改进因子为1/e。

Conclusion: 获得的更尖锐不等式改进了量子信息理论中的解耦、凸分裂和覆盖引理等关键原语，从而得到更紧的有限资源界限。
...
### [25] [Photonic state engineering via energy-level crossing by giant atoms in topological waveguide QED setup](https://arxiv.org/abs/2604.14660)
*Mingzhu Weng,Gang Wang,Zhihai Wang*

Main category: quant-ph

TL;DR: 拓扑波导QED中通过巨原子非局域耦合实现光子束缚态的可编程控制


<details>
  <summary>Details</summary>
Motivation: 传统波导QED中的光子态工程通常基于局域光-物质相互作用，这限制了其对光子束缚态空间结构的控制能力。本文旨在探索如何结合拓扑能带结构和非局域巨原子耦合来实现对束缚光子态的更高级控制。

Method: 将巨原子耦合到Su-Schrieffer-Heeger拓扑波导中，利用拓扑能隙保护的可控能级交叉点。通过绝热地扫描原子失谐穿过交叉点，实现不同光子束缚态之间的受控交换。在双巨原子配置中实现空间分裂态到结合态的转换，在三巨原子配置中实现形状保持的光子转移。

Result: 该机制实现了：1）受拓扑能隙保护的可控能级交叉；2）通过绝热扫描实现不同光子束缚态之间的受控交换；3）双巨原子配置中实现高保真度的空间分裂态到结合态转换；4）三巨原子配置中实现鲁棒的、形状保持的光子转移。

Conclusion: 拓扑结构和非局域光-物质耦合的结合为波导QED平台中束缚光子态的可编程控制提供了新途径，超越了传统局域相互作用的限制，实现了对光子态空间结构的精确操控。
...
TL;DR: 量子Mpemba效应与量子测温存在内在联系：在非平衡热化早期，最优测温初态大概率表现出量子Mpemba效应，能更快达到热平衡


<details>
  <summary>Details</summary>
Motivation: 量子Mpemba效应（QMpE）描述了远离平衡的量子态比接近平衡的态更快热化的反常现象。虽然已在多种框架中研究，但其在量子信息处理中的实际应用仍待探索。本文旨在探究QMpE与量子测温之间的关系，特别是在非平衡热化早期进行测量的场景。

Method: 在马尔可夫模型中，严格证明了在非平衡热化早期进行测温时，最优的初始态大概率表现出量子Mpemba效应。这些最优测温初态比大多数初始态热化得更快。

Result: 研究发现量子Mpemba效应与量子测温之间存在根本性联系。最优测温初态不仅表现出QMpE，而且热化速度显著快于普通初始态。这为利用QMpE增强量子探针的温度估计提供了理论基础。

Conclusion: 量子Mpemba效应可被用于增强量子测温性能。该研究揭示了量子热力学与测温之间的深刻联系，为非平衡量子热力学在量子信息处理中的应用开辟了新途径。
...
TL;DR: 提出基于见证算子的连续变量资源量化框架，可将CV资源操作性地激活为离散变量纠缠或EPR导引，为Wigner负性、真实非高斯性和标准非高斯性三种CV资源理论定义无限族有界见证单调量。


<details>
  <summary>Details</summary>
Motivation: 为连续变量资源理论提供统一的量化框架，将CV资源与实验可访问的DV关联建立直接联系，解决CV资源操作激活和量化的问题。

Method: 基于见证算子的框架，定义无限族有界见证单调量；构造见证依赖的CPTP测量-制备信道，输出两量子比特Werner态；对闭凸自由集证明单调量的忠实性、强单调性、Lipschitz连续性和凸性；对闭非凸自由集采用双拷贝提升。

Result: 对于n=m=1的代表性情况，最优纠缠和EPR导引与底层单调量精确成正比；框架应用于奇宇称态、纯损耗单光子态和GKP态，推导出纯态GNG和SNG的显式下界。

Conclusion: 闭CV自由集允许基于见证的量化器，具有直接的操作解释，可将CV资源与实验可访问的DV关联联系起来，为CV资源理论提供统一框架。
...
<details>
  <summary>Details</summary>
Motivation: 研究全连接Ising模型在不同对称块内的动力学行为，探索单一参数设置下系统如何同时展现可积和混沌特性，为量子混沌研究提供新平台。

Method: 将系统的每个对称扇区映射到受击陀螺模型，分析不同对称块的动力学特性，并研究噪声哈密顿量范数接近1时系统的鲁棒性。

Result: 系统在不同对称块中展现出从可积到混沌的混合动力学行为，当噪声哈密顿量范数接近1时系统保持鲁棒性，受击陀螺参数依赖于对称扇区维度。

Conclusion: 全连接Ising模型为研究对称扇区决定的动力学提供了新平台，类似于经典混沌中的Bunimovich台球，推进了量子混沌研究。
...
TL;DR: 该论文研究了HHL量子算法中演化态的相干性动力学，使用Tsallis相对α熵和l_{1,p}范数相干性度量，分析了相位估计和逆相位估计算子的相干性对算法参数和成功概率的依赖关系。


<details>
  <summary>Details</summary>
Motivation: 量子相干性是量子力学和量子信息处理的基本问题。HHL量子算法用于求解线性方程组，研究其演化过程中的相干性动力学对于理解量子算法的资源消耗和优化具有重要意义。

Method: 使用Tsallis相对α熵相干性和l_{1,p}范数相干性两种度量方法，分析HHL算法中相位估计算子P和逆相位估计算子~P的相干性。研究相干性与系数β_i（|b⟩在A特征基下的分解系数）、A的特征值以及算法成功概率P_s之间的关系。
...
Conclusion: HHL量子算法中演化态的相干性动力学与算法参数密切相关，特别是相位估计和逆相位估计算子的相干性分别依赖于不同的参数集。相干性变化受成功概率影响，这为理解量子算法中的资源消耗和优化提供了理论依据。
...
TL;DR: 提出了一种用于含时薛定谔方程的对数微扰理论扩展，通过波函数对数的耦合常数展开，得到基于Duhamel公式的封闭积分表达式，可计算瞬时能量移动和动态能量移动（如AC斯塔克移动）。
...
Method: 将对数微扰理论扩展到含时情况：将波函数的对数按耦合常数展开，得到由未扰动系统的规范旋转哈密顿量控制的微扰修正方程层次结构，基于Duhamel公式得到含时修正的封闭积分表达式。

Result: 该方法成功应用于谐振子和氢原子在含时激光场驱动下的情况：谐振子验证了方法的正确性（恢复精确解），氢原子展示了在原子系统中的应用。数值模拟表明能够高精度获得相关物理可观测量。

Conclusion: 该含时对数微扰理论方法为分析研究含时多光子过程的微扰区域提供了有前景的替代方案，特别适用于计算瞬时能量移动和动态能量移动（如AC斯塔克移动和电极化率）。
...
TL;DR: 研究相干驱动二能级量子系统在欧姆声子环境中的非单调温度敏感性，发现量子费希尔信息在中等耦合强度出现峰值，表明存在热传感最优区域
...
Method: 采用幺正极化子变换处理相干驱动二能级量子系统与欧姆声子环境的耦合，考虑超越弱耦合近似的声子诱导重整化效应，分析量子费希尔信息随系统-环境耦合强度的变化

Result: 量子费希尔信息在中等系统-环境耦合强度处出现显著峰值，表明存在热传感最优区域；热测量精度在超弱和强耦合极限下消失，但适当调谐的非平衡稳态可显著增强灵敏度

Conclusion: 环境相互作用可被工程化为优化固态量子温度计性能的资源，而非仅仅是退相干源；通过适当调谐非平衡稳态，可在中等耦合强度实现显著增强的热传感灵敏度
...
TL;DR: 提出一种自适应级联量子纠错码选择方法，通过估计每级后的有效噪声通道并据此选择下一级编码，结合学习型非加性编码器和标准码，显著减少所需量子比特数。


<details>
  <summary>Details</summary>
Motivation: 级联量子纠错码能双指数降低逻辑错误率，但噪声结构在级联过程中会发生变化，使得选择最优代码序列变得困难。需要自动化方法来根据噪声演变动态选择最合适的纠错码。

Method: 采用学习型方法自动选择级联代码序列：1) 估计每级纠错后的有效噪声通道；2) 当噪声具有足够结构时，使用学习型方法定制小型非加性编码器；3) 当噪声接近均匀时，切换为标准纠错码。形成混合、自适应的级联策略。

Result: 在模拟中，这种逐级自适应方法相比仅使用稳定子码的级联，能以更少的量子比特达到目标逻辑错误率。对于强结构噪声，量子比特数减少高达两个数量级。

Conclusion: 这种混合、基于学习的自适应级联策略为早期容错量子计算提供了有前景的工具，能显著降低资源需求，特别是在噪声具有结构性的实际场景中。
...
TL;DR: 提出一种新型量子LiDAR检测方案，仅当探测器接收到4n个光子时才计为点击，相比传统Z检测方案显著提升了分辨率和相位灵敏度的工作范围


<details>
  <summary>Details</summary>
Motivation: 在量子LiDAR系统中，检测方案对实现更好的分辨率和灵敏度至关重要。传统Z检测方案对任意数量光子都计为点击，存在局限性，需要开发更优的检测方案来提升系统性能

Method: 提出Z_{4n}检测方案，仅当探测器接收到4n（n∈ℕ）个光子时才计为点击，其余情况计为无点击。采用四相干态叠加（SFCS）和真空态作为输入，研究基于马赫-曾德尔干涉仪（MZI）的量子LiDAR系统性能

Result: 相比传统Z检测方案，Z_{4n}检测方案在分辨率方面有显著提升，相位灵敏度的工作范围更广，为量子LiDAR传感技术提供了更准确和灵敏的测量能力

Conclusion: Z_{4n}检测方案在量子LiDAR系统中展现出明显优势，为量子传感技术领域提供了有前景的进展，开辟了实现更精确和灵敏测量能力的新途径
...
TL;DR: 该论文研究了周期性驱动量子系统中的Floquet动力学量子相变，通过扩展XY自旋链模型和周期性通量淬火协议，揭示了通量差对FDQPTs出现的影响，并提出了Floquet淬火保真度概念。


<details>
  <summary>Details</summary>
Motivation: Floquet动力学量子相变揭示了周期性驱动量子系统中的非平衡临界现象，但其底层机制尚需深入研究。作者旨在探究周期性通量淬火协议中通量差对FDQPTs的影响，并建立更一般的理论框架。

Method: 采用扩展XY自旋链模型，施加周期性通量淬火协议。通过分析Loschmidt回波、速率函数、动力学拓扑序参数等物理量，研究通量差对FDQPTs的影响。提出Floquet淬火保真度概念，并讨论FDQPTs的充分必要条件。

Result: 发现FDQPTs的出现不仅取决于Floquet保真度条件，还与分段持续时间相关，这与传统的单次淬火场景不同。建立了适用于任意周期性驱动参数的通用框架，揭示了周期性协议如何控制量子多体系统中的非平衡相变。

Conclusion: 该研究为理解周期性驱动量子系统中的非平衡相变提供了新的理论框架，表明FDQPTs的出现机制比传统单次淬火更为复杂，需要同时考虑Floquet保真度条件和分段持续时间。该框架具有普适性，可应用于各种周期性驱动参数。
...
<details>
  <summary>Details</summary>
Motivation: 传统基于悬浮介观粒子的量子重力计未能充分利用粒子的大质量优势，因为常用的辅助量子系统抵消了质量作为资源的作用。需要克服这一限制，开发能直接利用机械量子比特作为重力传感器的新方案。

Method: 提出直接使用悬浮粒子形成的机械量子比特作为重力传感器，无需辅助量子系统，可直接读取粒子在重力影响下的运动。还将方案推广到使用机械猫态量子比特作为重力传感器。

Result: 灵敏度随质量m按m^{-1/2}比例缩放，使用机械猫态量子比特时进一步随平均声子数N按N^{-1/2}缩放。在实验可实现参数范围内，灵敏度可达0.1 μGal/√Hz，比传统方案提高两个数量级。
...
TL;DR: 该论文研究了三种HPC-量子计算资源调度方法：基于时间的复用、动态资源管理和工作流分解，以解决混合平台中量子与经典编程模型不匹配、量子软件栈不成熟及量子处理单元稀缺等问题。
...
Method: 研究了三种不同的HPC-QC资源调度方法：1) 基于时间的复用；2) 动态资源管理；3) 工作流分解。在生产的HPC集群和真实量子硬件上进行实验验证。

Result: 可塑性和工作流策略显著优化了经典资源利用率，分别减少消耗达45.7%和64%，最适合量子与经典工作负载均衡的混合作业。相反，时间复用提高了QPU利用率并减少了集群级执行时间，最适合经典-量子工作负载高度不平衡的场景。

Conclusion: 研究结果证明了为混合HPC-QC环境定制调度策略的实践可行性，并强调了它们在构建高效、可扩展的下一代量子加速设施软件栈中的互补性。
...
TL;DR: 该论文实现了1太赫兹带宽的全光量子隐形传态，突破了电子前馈的带宽限制，为太赫兹时钟量子计算奠定了基础。


<details>
  <summary>Details</summary>
Motivation: 光的固有载波频率可达数百太赫兹，理论上支持太赫兹时钟速率的信息处理。然而，在光学量子计算中，连续变量量子隐形传态作为确定性逻辑操作的基础模块，目前受限于电子前馈的带宽瓶颈（约100兆赫兹），无法充分利用光的极限速度。

Method: 采用全光量子隐形传态方案，完全绕过电子限制。通过光学方式传输贝尔测量结果，实现了太赫兹带宽的量子态传输。具体包括：1）在太赫兹频段传输真空态；2）实时传输42皮秒时间宽度的随机相干波包。

Result: 成功实现了1太赫兹带宽的全光量子隐形传态。对于宽带真空态，传输保真度达到F=0.784；对于动态相干波包，保真度为F=0.770。两个结果均严格超越了经典极限F=0.5，证明了超快速度下的真正量子隐形传态。

Conclusion: 研究表明光学量子处理速度仅受限于非线性介质的皮秒级响应时间，而非经典电子接口。该方法为突破摩尔定律的太赫兹时钟量子计算机奠定了基础，并为高容量、电信兼容的量子互联网开辟了道路。
...
TL;DR: 该论文研究了有限量子系统中所有状态同时回归到原始配置所需的时间，定义了量子系统的"回归时间"，并利用狄利克雷逼近定理获得了连续时间和离散时间下的界限。


<details>
  <summary>Details</summary>
Motivation: 研究有限量子系统中所有状态同时回归到原始配置的时间特性，这对于理解量子系统的动力学行为和周期性特征具有重要意义。量子系统的回归现象是量子力学中的一个基本问题，但所有状态同时回归的时间界限尚未得到充分研究。

Method: 使用狄利克雷逼近定理来分析量子系统的回归时间。将回归时间问题转化为实数差的有理数逼近问题，通过数学推导获得更紧的界限。方法包括：定义量子系统的回归时间，建立连续时间和离散时间下的分析框架，将问题与有理数逼近联系起来。

Result: 获得了有限量子系统回归时间的界限，包括连续时间和离散时间两种情况。通过将问题转化为有理数逼近问题，得到了比传统方法更紧的界限。提出了一个关于实数差有理数逼近的数学结果，并将其应用于量子系统回归时间的分析。

Conclusion: 量子系统的回归时间可以通过狄利克雷逼近定理和相关数学工具进行分析和界定。将回归时间问题转化为有理数逼近问题能够获得更精确的界限，这为理解量子系统的动力学行为提供了新的理论工具和视角。
...
TL;DR: 研究揭示了hBN中单个机械隔离量子发射器的光谱不稳定性机制，发现其源于电荷驱动的光谱扩散和自旋相关的暂态态共同作用


<details>
  <summary>Details</summary>
Motivation: 六方氮化硼中的机械隔离缺陷中心是潜在的相干量子发射器，但其光谱不稳定性和自旋相关性质尚不明确，需要深入理解其光学循环动力学机制

Method: 将单个机械隔离量子发射器集成到共面波导上，采用高分辨率光谱、时间分辨光谱、磁场依赖光致发光、光学检测磁共振和泵浦-探测测量等多种技术

Result: 发射器表现出超亮共振荧光，发现两个紧密间隔的零声子线跃迁，具有不同的光谱扩散动力学；蓝光照射可重新分布发射强度并提高发射占空比；揭示了毫秒尺度弛豫动力学和磁场依赖荧光对比度

Conclusion: 电荷驱动的光谱波动和自旋相关的暂态态共同塑造了光学循环动力学，为理解hBN量子发射器的光谱不稳定性和自旋性质提供了关键见解
...
TL;DR: 混合量子纠错与误差缓解策略：通过结合少量纠错后数据点与大量未纠错数据点进行零噪声外推，显著降低资源需求


<details>
  <summary>Details</summary>
Motivation: 在容错前量子计算阶段，部分量子纠错与量子误差缓解需要共存，但两者结合的资源优势尚未得到充分量化。研究混合数据集（包含少量纠错数据点和大量未纠错数据点）的零噪声外推策略，旨在降低资源需求。

Method: 提出混合数据零噪声外推方法：使用少量低噪声逻辑数据点（经过纠错）作为外推锚点，结合大量高噪声物理数据点（未纠错）扩大噪声基线。在纠错将有效门错误率从p抑制到γp的简单模型下，推导零噪声估计器的方差，并比较达到目标精度所需的物理运行时间。采用Richardson外推法，将方法应用于六自旋横向场伊辛模型的数字量子模拟进行验证。

Result: 混合数据策略显著降低了方差放大，当γ≤0.1时，可将所需物理运行时间降低数个数量级。在六自旋横向场伊辛模型的模拟中，混合物理/逻辑数据集产生了更低方差的零噪声估计，在所研究参数范围内优于仅基于纠错数据的外推。

Conclusion: 混合误差纠正与误差缓解策略是容错前资源高效量子计算的实际途径，通过结合少量纠错数据与大量未纠错数据进行零噪声外推，可在显著降低资源需求的同时提高估计精度。
...
TL;DR: 论文揭示了Jordan等人关于解码量子干涉测量量子优势区域边界的定理存在系统性低估，通过利用Perron特征向量的集中性改进边界，在标准基准实例上发现了26个连续参数点存在被低估的量子优势。


<details>
  <summary>Details</summary>
Motivation: 现有量子优势边界分析（Jordan等人的定理10.1）系统性地低估了解码量子干涉测量（DQI）的实际量子优势区域，需要更精确的边界分析方法。

Method: 利用DQI三对角矩阵的谱结构，特别是Perron特征向量的集中性，将均匀惩罚替换为加权平均ε_bar = Σ_k ε_k w_k^2，建立了适用于任意有限域F_q的统一下界（主定理）。

Result: 在标准部分获胜LDPC基准实例上，发现了26个连续参数点（l∈[642,667]）存在被低估的量子优势，近似比达到0.66，而原分析宣称无量子优势（<s>/m < 0.5）。新边界从三个独立来源严格改进了原边界。

Conclusion: 通过利用DQI的谱结构特征，建立了更精确的量子优势边界分析方法，证明了现有边界存在系统性低估，并提供了改进的统一下界，扩展了已知的量子优势区域。
...
### [42] [A NISQ-friendly Coined Quantum Walk Algorithm for Chaos-based Cryptographic Applications](https://arxiv.org/abs/2604.15030)
*Natalie Gibson,Niklas Keckman,Andrea Marchesin,Matti Raasakka,Ilkka Tittonen*

Main category: quant-ph

TL;DR: 提出了一种新型的懒散交替量子行走（LAQW）算法，其电路深度为O(n²+nt)，相比现有控制交替量子行走（CAQW）的O(n²t)有显著降低，适用于NISQ设备，并应用于基于混沌的对称密钥生成方案。


<details>
  <summary>Details</summary>
Motivation: 现有控制交替量子行走（CAQW）模型在n×n晶格上t时间步的电路深度为O(n²t)，深度较大，不适合当前NISQ设备实现。需要开发深度更浅的量子行走算法以在NISQ时代实现实用化。

Method: 提出懒散交替量子行走（LAQW）算法，通过优化电路设计将深度降低到O(n²+nt)。将该算法作为量子熵源，结合底层概率分布和后处理方法生成可复现的随机比特串序列，构建基于混沌的对称密钥生成方案。

Result: LAQW电路深度相比CAQW显著降低，从O(n²t)减少到O(n²+nt)。在IBM FakeTorino后端模拟的量子噪声环境下，成功演示了128位密钥的可复现性。与CAQW模型相比，LAQW在密码学应用中显示出更大潜力。

Conclusion: LAQW算法通过显著降低电路深度，使其适用于NISQ设备，为量子行走在密码学应用中的实际部署提供了可行方案。基于LAQW的混沌密钥生成方案展示了该模型在密码学领域的实用价值。
...
### [43] [SyQMA: A memory-efficient, symbolic and exact universal simulator for quantum error correction](https://arxiv.org/abs/2604.15043)
*George Umbrarescu,David Amaro*

Main category: quant-ph

TL;DR: SyQMA是一个量子电路模拟器，能够处理含噪声的通用量子电路，计算精确的符号化期望值和测量概率，支持动态量子程序，并为量子纠错提供电路级最大似然解码和逻辑错误率分析。


<details>
  <summary>Details</summary>
Motivation: 开发一个专门针对量子纠错需求的量子电路模拟器，能够处理含噪声的通用量子电路，提供精确的符号化分析，支持动态量子程序，并验证容错量子计算协议。

Method: 通过扩展稳定子模拟器，将非Clifford Pauli旋转和非相干Pauli信道紧凑地表示为辅助量子比特和修改后的迹。使用多项式内存表示状态，计算期望值和测量概率的时间与非Clifford旋转和确定性测量数量呈指数关系但内存需求仅为多项式。

Result: 实现了SyQMA模拟器，能够：1）模拟含噪声的通用量子电路；2）计算电路参数的符号函数；3）采样测量结果支持动态程序；4）执行电路级最大似然解码；5）提供逻辑错误率的精确符号表达式；6）验证容错稳定子和魔态制备协议的故障距离；7）将多量子比特Pauli信道的联合错误概率转换为独立错误概率。

Conclusion: SyQMA是一个功能强大的量子电路模拟器，特别适用于量子纠错应用，能够提供精确的符号化分析，支持动态量子程序，并为容错量子计算协议提供验证工具。代码已开源。
...
### [44] [Hardware Validation of DAGI via a Modular "Ridge" Signature and High-Order Synergistic Information](https://arxiv.org/abs/2604.15051)
*Petr Sramek*

Main category: quant-ph

TL;DR: 在IBM量子硬件上验证DAGI框架，通过模16乘法关系实验，在噪声环境下检测到高阶协同信息结构，支持密钥恢复能力。


<details>
  <summary>Details</summary>
Motivation: 验证DAGI框架在真实量子硬件上的有效性，特别是检测和量化与全局代数约束相关的高阶协同信息结构的能力，这些结构在低阶边际分布中不可见。

Method: 使用IBM Quantum硬件（ibm_torino）进行实验，设计4比特寄存器(u,v)的模16乘法关系：v ≡ k·u (mod 16)。采用Sampler V2作业（8个密钥，每个1024次采样，共8192次采样）。通过Möbius反演管道计算信息分解，评估目标正协同CPS_K，使用标签置换检验进行显著性测试。

Result: 在硬件噪声下脊线持续存在：脊线命中概率p_hit=0.1830（均匀基线1/16），脊线对比度2.93倍。密钥恢复超过随机水平：每采样准确率0.1689（随机0.125），每组字典恢复0.375（随机0.125）。观察到显著的三阶目标正协同CPS_K(k=3)=0.08788，置换检验p值分别为0.001996（准确率）和0.004975（CPS_K）。

Conclusion: 实验结果支持DAGI框架能够检测和量化与已知全局代数约束相关的非平凡、硬件弹性的高阶信息结构，这些结构主要存在于高阶协同中而非低阶边际分布中。
...
### [45] [Quantum instanton approach to metastable collective spins](https://arxiv.org/abs/2604.15091)
...
<details>
  <summary>Details</summary>
Motivation: 集体自旋系统在原子和固体物理中具有重要性，其内在非线性导致多稳态和一级相变，但现有半经典Wigner方法无法准确描述这些特征

Method: 开发基于量子准概率动力学的实时瞬子方法，在大自旋极限下捕捉稳态，并分析弛豫速率的渐近标度行为

Result: 该方法能准确描述集体自旋系统的稳态和弛豫速率标度，而先前应用的半经典Wigner方法因忽略非高斯涨落而无法准确描述这些特征

Conclusion: 量子准概率动力学的实时瞬子方法为集体自旋系统的相变和弛豫动力学提供了更准确的描述框架，强调了非高斯涨落的关键作用
...
<details>
  <summary>Details</summary>
Motivation: 解决NISQ时代对高性能、可扩展量子编译器的迫切需求，推进经典计算与量子计算的集成，为未来量子软件开发提供高效的工业级编译基础设施。
...
Conclusion: QLLVM提供了一个高效、灵活、工业级的编译基础设施，能够统一编译经典高性能程序和量子程序，为未来量子软件开发提供了重要的技术基础。
...
<details>
  <summary>Details</summary>
Motivation: 表面码是实现容错量子计算的主要候选方案，晶格手术是实现FTQC的有前景技术。现有方法主要关注大布局设计，编译器优化重点在时间开销，忽视了旋转瓶颈与移动距离之间的权衡，导致资源利用率低，无法进一步降低量子计算失败率。

Method: 提出O3LS框架，包含：1）自动生成压缩数据布局以减少空间需求；2）结合电路合成技术的宽松调度算法以减少时间开销；3）通过自动布局搜索在空间和时间开销之间取得最优平衡。

Result: 相比标准布局空间开销减少28.0%，相比稀疏布局减少46.7%，且不增加时间步数；逻辑错误率相对大布局设计降低达16%；紧凑和标准数据布局设计中时间开销分别减少36.07%和24.76%；相比主要关注并行化的先前编译器，逻辑错误率降低达一个数量级。

Conclusion: O3LS通过自动布局搜索和宽松调度优化晶格手术，在空间和时间开销之间取得平衡，有效降低逻辑错误率，为实现大规模实用化量子计算提供了更高效的容错量子计算框架。
...
Method: 结合Weyl室表示与算子Schmidt理论，将门合成解释为到行列式簇的距离问题，使用三种不同的行列式代价函数

Result: 证明平方根iSWAP门是离局域操作簇最近的完美纠缠器，完美纠缠器无法被平均门保真度超过79.8%的局域门近似

Conclusion: 行列式代价函数形成合成适应的坐标系，编码非局域复杂度并重构Weyl室，为量子门合成提供几何理解
...
TL;DR: 该论文系统研究了无源SU(2)杨-米尔斯方程的静态解，其中规范势显式依赖于自旋算符。通过向量势提取方法(VPEA)，推导出最一般的自旋向量势形式，并完整分类了静态解，包括实数和复数解族。


<details>
  <summary>Details</summary>
Motivation: 研究SU(2)杨-米尔斯方程中显式依赖自旋算符的静态解，旨在系统分类这些解，为微扰研究和自旋自由度与非阿贝尔规范场耦合的模型提供新的静态构型。

Method: 采用向量势提取方法(VPEA)，要求总角动量算符满足标准角动量代数，推导出最一般的自旋向量势形式。将静态ansatz代入杨-米尔斯方程并施加VPEA的角动量约束，得到一致性方程组，通过求解这些方程完成静态解的分类。

Result: 获得了包含三个常数{k₁,k₂,k₃}和两个径向函数{f₁(r),f₂(r)}的静态ansatz。求解一致性方程后，完整分类了静态解，包括实数和复数解族。已知的简单SU(2)静态解作为特例被恢复，同时发现了新的静态构型。

Conclusion: 该研究系统分类了SU(2)杨-米尔斯方程中显式依赖自旋算符的静态解，揭示了新的静态构型。这些结果为非微扰研究以及自旋自由度与非阿贝尔规范场耦合的模型提供了有价值的配置。
...
TL;DR: 幻影码（phantom codes）虽然能通过物理置换实现所有块内逻辑CNOT电路，但编码率极低，受限于对数上界k≤log₂(n+1)，且存在一个特殊的k=4例外情况。


<details>
  <summary>Details</summary>
Motivation: 研究幻影码在实现容错量子计算时的优势与代价。幻影码允许通过物理置换实现所有块内逻辑CNOT电路，这能显著减少编译电路的深度，但需要探究这种特性是否以牺牲编码率为代价。

Method: 通过数学证明分析二进制幻影码的编码率限制，构造k=4的特殊例外码，研究CSS幻影码的饱和边界情况，并扩展到包含额外局部幺正门和子系统码的情况。

Result: 证明对于距离d≥2的二进制幻影码，当k≠4时满足k≤log₂(n+1)的严格上界；构造了一个k=4的(8,2⁴,2)非稳定子幻影码违反该边界；发现CSS幻影码中存在唯一达到该边界的码族；证明该对数边界无法通过额外局部幺正门或子系统码规避。

Conclusion: 幻影码的"幻影"特性（所有块内逻辑CNOT电路可通过物理置换实现）以极低的编码率为代价，存在严格的对数上界限制。这一结果基于自同构群结构的通用定理，可能应用于幻影码之外的其他量子码研究。
...
TL;DR: 提出一种基于相干反馈的腔光力学系统量子关联调控方案，通过光学和力学参数放大与反馈回路联合调制，增强量子关联并提高其抗热噪声鲁棒性。


<details>
  <summary>Details</summary>
Motivation: 腔光力学系统是实现量子信息处理的理想平台，但量子关联通常对热噪声敏感且调控灵活性有限。需要开发能同时增强量子关联强度、提高热噪声鲁棒性并实现高度可调谐的控制方案。

Method: 在包含非线性介质和薄膜的驱动光学腔中，通过泵浦实现光学和力学参数放大，结合相干反馈回路联合调制。通过控制调制频率和泵浦幅度来调控有效腔衰减率和量子涨落分布。

Result: 该方案能有效增强量子关联强度并显著提高其抗热噪声能力，实现了高度可调谐、强且热鲁棒的量子关联，为保护脆弱量子资源提供了有效途径。

Conclusion: 提出的相干控制方案为腔光力学系统实现高度可调谐、强且热鲁棒的量子关联提供了有效方法，在量子资源保护方面具有重要应用前景。
...
TL;DR: 该论文构建并模拟了基于Claudon等人框架的量子Metropolis-Hastings算法的具体电路级实现，展示了实现正确稳态分布所需的完整量子工作流程和必要修改。


<details>
  <summary>Details</summary>
Motivation: 量子Metropolis-Hastings算法通过量子游走有望加速混合过程，但其实际实现仍然具有挑战性。需要构建可实现的量子电路模型来验证算法的可行性。

Method: 基于Claudon等人提出的框架，构建了量子Metropolis-Hastings算法的显式电路级实现，包括对原始框架的必要修改以使其在现实量子电路模型中可实施。

Result: 模拟结果表明，这些修改对于恢复正确的稳态行为至关重要。研究同时揭示了量子Metropolis-Hastings算法的潜力和当前局限性。

Conclusion: 量子Metropolis-Hastings算法预计在容错量子计算时代将变得实际相关，当前研究为实现这一目标提供了重要的电路级实现和验证。
...
TL;DR: 通过变分量子电路优化量子费舍尔信息，在噪声环境下生成用于精密测量的量子态，采用纠缠-旋转架构，在可观噪声率下随电路深度增加显著提升QFI。


<details>
  <summary>Details</summary>
Motivation: 研究如何在存在噪声的两能级系统中生成用于精密测量的量子态，探索在现实噪声条件下扩展可访问态空间的方法，为量子增强传感提供通用框架。

Method: 设计受扭转变换启发的变分量子电路架构，包含n个纠缠层，每层由纠缠门和全局旋转组成。通过优化电路参数最大化输出态的量子费舍尔信息，考虑不同退相干率和相互作用哈密顿量。分析扩展到从全连接到最近邻相互作用的幂律相互作用系统。

Result: 观察到即使存在可观噪声率，随着电路层深度增加，量子费舍尔信息显著改善。纠缠-旋转架构在现实噪声条件下扩展了可访问态空间。方法可扩展到超过8个量子比特的系统规模。

Conclusion: 该变分方法为生成量子增强传感态提供了通用高效框架，在噪声环境下仍能实现量子优势，适用于多种相互作用类型和较大系统规模。
...
### [54] [Simulation of quantum annealing on a semiconducting cQED device for Multiple Hypothesis Tracking (MHT) benchmark](https://arxiv.org/abs/2604.15213)
*Quentin Schaeverbeke,Viktor Radović,Jean-Marc Divanon,Bing Hong Teh*

Main category: quant-ph

TL;DR: 评估半导体自旋cQED量子处理器通过量子退火执行多假设跟踪算法的性能，在量子模拟器中测试了相干和非相干误差，发现总运行时间约50毫秒，有望用于雷达跟踪等实时应用


<details>
  <summary>Details</summary>
Motivation: 探索半导体自旋cQED量子处理器在量子退火框架下执行多假设跟踪算法的性能潜力，评估该技术是否适用于雷达跟踪等实时应用场景

Method: 使用量子模拟器进行基准测试，模拟器中集成了动态相干误差和非相干误差，通过估计处理器的重置、测量和退火时间来评估性能

Result: cQED自旋处理器总运行时间可达约50毫秒，这一性能使其在雷达跟踪等实时应用中具有潜力

Conclusion: 半导体自旋cQED量子处理器通过量子退火执行多假设跟踪算法表现出良好性能，约50毫秒的运行时间使其成为雷达跟踪等实时应用的有前景技术
...
### [55] [Optimal algorithmic complexity of inference in quantum kernel methods](https://arxiv.org/abs/2604.15214)
...
<details>
  <summary>Details</summary>
Motivation: 量子核方法在监督学习中具有实现量子优势的潜力，但推理成本高昂：评估新数据模型需要估计N个核值的加权和，标准方法通过独立采样估计每项，查询复杂度为O(N∥α∥₂²/ε²)，这成为主要瓶颈。

Method: 系统分析两个独立改进维度：(1) 单个核值估计方法（采样vs量子振幅估计），(2) 求和近似方式（逐项vs单个可观测量）。将所有组合进行系统分析，提出查询最优组合：将完整推理和编码为单个可观测量期望值，并应用量子振幅估计。

Result: 查询最优算法实现O(∥α∥₁/ε)的查询复杂度，消除了对N的依赖，在∥α∥₁和ε上均获得二次改进。证明匹配的下界Ω(∥α∥₁/ε)，确立了查询最优性（至对数因子）。分析门成本转换，发现查询最优策略在门复杂度上并非总是实际最优。

Conclusion: 提供了查询最优算法和根据硬件能力选择的实际最优策略，以及完整的中间方法图谱指导实践。所有算法仅需振幅估计作为子程序，适合早期容错实现。在查询复杂度上实现了理论最优，同时在门成本方面提供了实用指导。
...
### [56] [Universal quantum state purification with energy-preserving operations](https://arxiv.org/abs/2604.15228)
*Xing-Chen Guo,Benchi Zhao,Xin Wang*

Main category: quant-ph

TL;DR: 提出了一个在能量守恒约束下的通用量子态纯化框架，解决了现有纯化协议忽略实际量子设备能量限制的问题


<details>
  <summary>Details</summary>
Motivation: 现有量子态纯化协议通常假设无约束操作，忽略了实际量子设备固有的能量守恒限制，需要建立能量约束下的纯化理论框架

Method: 建立能量守恒约束下的通用态纯化框架，推导不存在通用能量守恒纯化的充要条件，确定可行时的最优性能和相应协议，并展示如何仅用能量守恒操作系统实现

Result: 数值结果证实了所提方案的有效性，框架将标准纯化作为特例恢复，并自然扩展到外部能量资源辅助的场景

Conclusion: 该工作确定了态蒸馏的基本物理极限，为量子误差缓解提供了能量高效路径
...
### [57] [IQP circuits for 2-Forrelation](https://arxiv.org/abs/2604.15248)
*Quentin Buzet,André Chailloux*

Main category: quant-ph

TL;DR: 本文证明2-Forrelation问题可以用IQP电路解决，仅需两个量子查询和高效经典处理，为IQP电路在决策问题中展示量子优势提供了新途径。


<details>
  <summary>Details</summary>
Motivation: 2-Forrelation问题在经典与量子查询复杂度间提供了最优分离，并被用于证明BQP与PH在预言机下的分离。一个自然的问题是：解决此问题所需的最小量子资源是什么？本文旨在探索IQP电路（一种所有门可交换的受限量子计算模型）能否解决2-Forrelation问题。

Method: 使用IQP电路解决2-Forrelation问题。具体方法包括：1）利用二次函数Q(x)=∑_{i<j}x_ix_j的代数恒等式在IQP电路中提取内积相位；2）对于标准2-Forrelation，使用两个IQP电路配合两个量子查询和高效经典处理；3）对于有符号变体，仅需单个IQP电路和一个查询。

Result: 1）证明2-Forrelation问题可以用IQP电路解决；2）对于有符号变体，单个IQP电路和一个查询即可解决；3）基于此证明了(BPP^IQP)^O ⊈ PH^O相对于预言机O，强化了Raz和Tal的结果；4）证明了IQP电路的傅里叶增长界与其接受集大小的关系。

Conclusion: IQP电路能够解决经典困难的决策问题，为通过IQP电路展示量子优势提供了新途径，避免了采样任务相关的验证困难。这回答了Girish关于交换量子计算能力的开放问题，并强化了相关复杂性分离结果。
...
### [58] [Computing the free energy of quantum Coulomb gases and molecules via quantum Gibbs sampling](https://arxiv.org/abs/2604.15263)
*Simon Becker,Cambyse Rouzé,Robert Salzmann*

Main category: quant-ph

TL;DR: 提出量子算法估计量子库仑气体和分子系统的自由能和吉布斯态，解决奇异相互作用和无限维希尔伯特空间的挑战


<details>
  <summary>Details</summary>
Motivation: 现有方法无法处理具有奇异相互作用和无限维希尔伯特空间结构的量子库仑气体和分子系统，需要开发新的量子算法来精确估计其自由能和吉布斯态

Method: 1) 通过有限秩低能截断近似全哈密顿量的自由能，获得多项式误差界；2) 为截断系统设计基于量子马尔可夫半群的吉布斯采样方案；3) 证明生成元具有严格正谱隙，确保指数收敛；4) 给出量子电路实现和端到端复杂度分析

Result: 1) 建立了自由能近似与截断误差的多项式界；2) 证明了量子马尔可夫半群生成元的严格正谱隙，首次为库仑相互作用连续变量量子系统提供了严格的吉布斯采样混合时间保证；3) 给出了量子电路实现和完整的复杂度分析

Conclusion: 该工作为量子库仑气体和分子系统的自由能估计提供了数学上严格的量子算法路径，无需依赖玻恩-奥本海默近似等经典近似，首次解决了这类系统的量子计算挑战
...
### [59] [Assembling Extensive Quantum Fisher Information in Stabilizer Systems](https://arxiv.org/abs/2604.15268)
*Arnau Lira-Solanilla,Sreemayee Aditya,Xhek Turkeshi,Silvia Pappalardi*

Main category: quant-ph

TL;DR: 提出一个系统框架，在稳定子码中构建具有广泛量子费希尔信息密度的非局域可观测量，将隐藏的非局域序转化为可测量的观测值


<details>
  <summary>Details</summary>
Motivation: 稳定子码中的非局域序通常难以直接测量，需要将其转化为可实验访问的观测量以实现量子计量应用

Method: 将稳定子生成元映射到对偶伊辛自旋，其关联函数等于弦序参数，从而将隐藏的非局域序转化为可测量的观测量

Result: 应用于监控簇码和环面码时，发现量子费希尔信息标度存在相变：从长程弦序主导的广泛区域到单点测量驱动的密集区域

Conclusion: 该框架成功将稳定子码中的隐藏非局域序转化为可测量的观测量，揭示了量子计量能力与弦序之间的深刻联系
...
### [60] [Cloning is as Hard as Learning for Stabilizer States](https://arxiv.org/abs/2604.15269)
*Nikhil Bansal,Matthias C. Caro,Gaurav Mahajan*

Main category: quant-ph

TL;DR: 该论文研究了稳定子态的学习与克隆复杂度关系，证明对于n-量子比特稳定子态，最优克隆样本复杂度为Θ(n)，表明克隆与学习同样困难。


<details>
  <summary>Details</summary>
Motivation: 量子理论的基础之一是禁止克隆非正交态。现代量子学习理论常考虑结构化态类，并利用结构开发优于通用态层析的学习算法。这引发了一个问题：对于此类结构化态类，学习与克隆的样本复杂度有何关系？

Method: 使用最近提出的阿贝尔态隐藏子群框架中的表示论工具，以及新引入的结构化随机纯化通道，将稳定子态克隆与经典学习理论中最近引入的概率分布样本放大问题的变体联系起来。

Result: 对于n-量子比特稳定子态，最优克隆样本复杂度为Θ(n)，表明克隆与学习同样困难。通过证明具有底层线性结构的分布类的样本放大下界，获得了克隆下界。

Conclusion: 结果为不可克隆定理提供了更细粒度的视角，建立了从基础理论到量子学习理论和量子密码学的联系。
...
### [61] [Generation of Schrödinger cat-like states via degenerate dual pump spontaneous four-wave mixing in a $χ^{(3)}$ microring resonator](https://arxiv.org/abs/2604.15275)
...
<details>
  <summary>Details</summary>
Motivation: 研究动机是开发在集成光子平台上产生和控制非高斯量子态（如薛定谔猫态）的方法。传统方法通常使用半经典或参量近似，忽略了泵浦耗尽效应，而该研究旨在通过全量子力学方法更准确地描述非高斯特征的产生。

Method: 采用简并双泵浦自发四波混频在χ³微环谐振腔中产生量子态。通过引入酉变换精确解耦自相位调制和交叉相位调制项，将完整非线性哈密顿量简化为有效三模相互作用。使用林德布拉德主方程研究动力学，考虑腔损耗，并计算维格纳函数、光子数分布、正交方差、法诺因子、施密特数和保真度等表征指标。

Result: 在无耗散情况下，信号模式呈现清晰的非高斯特征：结构化维格纳函数和偶数主导的光子数分布，类似偶相干态。在耗散条件下（γ_j=0.2），干涉条纹变弱，奇数光子数出现，但与理想态的保真度仍高于0.9，显示鲁棒性。泵浦模式保持高斯特性，两模式均显示超泊松统计和纠缠（>2）。

Conclusion: 简并双泵浦自发四波混频在微环谐振腔中是产生和控制猫态的有前景平台，特别是在耗散条件下仍能保持高保真度。全量子力学方法能更准确地捕捉非高斯特征，为集成量子光学应用提供了理论基础。
...
### [62] [Super-Constant Weight Dicke States in Constant Depth Without Fanout](https://arxiv.org/abs/2604.15298)
*Lucas Gretta,Meghal Gupta,Malvika Raj Joshi*

Main category: quant-ph

TL;DR: 该论文提出了在QAC⁰电路类中制备Dicke态和任意对称态的常数深度量子电路构造，建立了FANOUT门能力与Dicke态可制备性之间的紧致对应关系。


<details>
  <summary>Details</summary>
Motivation: Dicke态是NISQ时代重要的纠缠资源，在解码量子干涉仪等应用中具有核心作用。现有常数深度构造需要FANOUTₙ门，而QAC⁰电路仅能实现FANOUTₖ（k≤polylog(n)），因此需要研究在QAC⁰限制下制备超常数权重Dicke态的方法。

Method: 使用多量子比特Toffoli门和单量子比特幺正操作构建常数深度电路。关键创新是：1) 对任意k≤polylog(n)的n量子比特Dicke态给出显式构造；2) 证明权重k的Dicke态仅需FANOUTₘᵢₙ(ₖ,ₙ₋ₖ)而非FANOUTₙ；3) 扩展技术以制备任意Dicke态叠加。

Result: 1) 首次在QAC⁰中构造了超常数权重的Dicke态；2) 建立了紧致特征：对于k≤n/2，权重k的Dicke态可在QAC⁰中制备当且仅当FANOUTₖ∈QAC⁰；3) 实现了任意对称态的常数深度幺正构造，特别适用于支持FANOUTₙ的量子硬件架构。

Conclusion: 该工作解决了QAC⁰电路中Dicke态和对称态制备的基本问题，为NISQ时代量子算法提供了实用的常数深度实现方案，并建立了电路复杂度与门资源之间的理论对应关系。
...
### [63] [Ensembles of random quantum states tunable from volume law to area law](https://arxiv.org/abs/2604.15300)
*Héloïse Albot,Sebastian Paeckel*

Main category: quant-ph

TL;DR: 提出σ-ensemble随机量子态族，通过单一参数控制可在体积律和面积律之间调节，解决了Haar随机态在经典模拟中的计算难题


<details>
  <summary>Details</summary>
Motivation: Haar随机纯态虽然标准但存在根本挑战：其纠缠特性限制了在量子系统经典模拟中的适用性，特别是无法在体积律和面积律之间灵活调节

Method: 通过在对连续子系统的特征值上施加概率分布来构造σ-ensemble代表态，然后使用矩阵乘积态（MPS）形式重构兼容的全局态

Result: 构建了可通过单一参数在体积律和面积律之间调节的随机量子态族，其面积律纠缠特性避免了Haar随机纯态在经典模拟中的难处理性

Conclusion: σ-ensemble为量子系统经典模拟提供了更实用的随机态生成方法，能更好地代表典型哈密顿量基态，克服了Haar随机态的主要限制
...
### [64] [Heuristic Search for Minimum-Distance Upper-Bound Witnesses in Quantum APM-LDPC Codes](https://arxiv.org/abs/2604.15307)
*Kenta Kasai*

Main category: quant-ph

TL;DR: 该研究为基于仿射置换矩阵构造的CSS量子LDPC码的最小距离提供了经过认证的上界证明，通过构造低权重非稳定子逻辑代表元来获得有效上界。


<details>
  <summary>Details</summary>
Motivation: 研究动机在于为特定构造的量子LDPC码提供精确的距离上界认证，而非尝试证明一般性的距离下界。现有方法往往难以确定这类代码的确切最小距离，因此需要开发系统化的认证框架来获得可靠的上界估计。

Method: 开发了统一的认证框架，通过四种途径构造低权重非稳定子逻辑代表元：1) 潜在行关系；2) 受限提升子空间（包括块压缩、选择纤维和CRT条纹构造）；3) 环-8基本陷阱集结构；4) 解码器失败残差。所有候选都经过明确的核和行空间排除测试验证，搜索仅用于生成候选。

Result: 将方法应用于代表性APM-LDPC码，改进了先前报告的上界，并在探索的参数范围内提供了具体的认证值。对于潜在行关系部分，还确定了块压缩准则，在该准则下认证变为精确。

Conclusion: 该研究为量子LDPC码的距离认证提供了系统化的框架，通过构造经过验证的低权重逻辑代表元来获得可靠的上界。该方法特别适用于具有环-8 Tanner图的代码，为这类重要量子代码的性能评估提供了实用工具。
